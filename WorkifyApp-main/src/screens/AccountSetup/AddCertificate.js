...
export default class AddCertificate extends Component {
  ...
  validateCertificate = () => {
    ...
    const {certificateName, certificateYear, certificateMonth} = this.state;

    if (certificateName === '') {
      errors['certificateName'] = 'Please enter certificate name';
      formIsValid = false;
    }

    if (certificateYear === '') {
      errors['certificateYear'] = 'Please enter certificate year';
      formIsValid = false;
    }

    if (certificateMonth === '') {
      errors['certificateMonth'] = 'Please enter certificate month';
      formIsValid = false;
    }
  ...
  validateLicence = () => {
    let errors = {};
    let formIsValid = true;
    const {licenceName, licenceYear, licenceMonth} = this.state;

    if (licenceName === '') {
      errors['licenceName'] = 'Please enter licence name';
      formIsValid = false;
    }

    if (licenceYear === '') {
      errors['licenceYear'] = 'Please enter licence year';
      formIsValid = false;
    }

    if (licenceMonth === '') {
      errors['licenceMonth'] = 'Please enter licence month';
      formIsValid = false;
    }
  ...
  addCertificateFun = () => {
    const {certificateYear, certificateMonth, token, userId, certificateId} =
      this.state;
    console.log(userId);
      ...
      <Modal
        ...
        <View style={style.centeredView}>
          ...
          <View style={[style.modalView, {height: verticalScale(500)}]}>
            <View style={style.bodyView}>
              <View style={style.topView}>
                <Text style={style.preferenceTxt}>Licence</Text>
                <Icon
                  name="cross"
                  type="Entypo"
                  style={style.crossIcon}
            ...
            <View style={style.bodyView}>
              ...
              <View style={style.fromcontrol}>
                ...
                <TouchableOpacity
                  ...
                  <Text
                    style={{
                      color: this.state.certificateName ? '#272727' : '#969696',
                    }}>
              ...
              <View style={style.fromcontrol}>
                <Text style={style.gobleleble}>Certificate Expiry Date</Text>
  ...
  licenceInfoModal = () => {
    return (
      <Modal
        ...
        onRequestClose={() => this.setState({licenceInfoModalOpen: false})}>
        <View style={style.centeredView}>
          <Pressable
            style={{flex: 1}}
  ...
  render() {
    ...
    console.log(isSelected, isSelectedNew);
    return (
      <SafeAreaView style={{flex: 1}}>
        ...
        <TouchableOpacity
          ...
          onPress={() => this.props.navigation.navigate('CertificateSuccess')}>
