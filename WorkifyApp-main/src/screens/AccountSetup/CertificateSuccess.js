...
export default class CertificateSuccess extends Component {
  constructor(props) {
    super(props);
    this.state = {
      infoModalOpen: false,
                    ...
                    <View style={style.bodyContainer}>
                      ...
                      <View style={{flexDirection: 'row', marginTop: 0}}>
                        ...
                        <Text
                          ...
                          certifications and licenses you might possess which
                          may be relevant to gigs that they post.
                        </Text>
                      </View>
                      <View style={{flexDirection: 'row', marginTop: 0}}>
                        <Text style={{fontSize: 32}}>{'\u2022'}</Text>
                        <Text
                          ...
                          This also increases your chances of securing a gig
                          that may require certain certificates and licenses.
                        </Text>
                      </View>
                      <View style={{flexDirection: 'row', marginTop: 0}}>
                        <Text style={{fontSize: 32}}>{'\u2022'}</Text>
                        <Text
                          ...
                          Examples include: Class 4 Driver’s License, FOODSAFE
                          Level 1, Serving it right
                        </Text>
                      </View>
                    </View>
                  </ScrollView>
            ...
            <View style={[style.cardView]}>
              <View
                ...
                <Text
                  ...
                  Awesome! Your certificate and licence has been added.
                </Text>
              </View>
              <TouchableOpacity
                style={{
