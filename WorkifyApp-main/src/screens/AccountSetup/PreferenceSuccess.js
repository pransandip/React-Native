...
export default class PreferenceSuccess extends Component {
  constructor(props) {
    super(props);
    this.state = {
      infoModalOpen: false,
                    ...
                    <View style={style.bodyContainer}>
                      <View style={{flexDirection: 'row', marginTop: 0}}>
                        ...
                        <Text
                          ...
                          Entering a home location and a preferred working
                          radius helps us identify and show you more gigs that
                      ...
                      <View style={{flexDirection: 'row', marginTop: 0}}>
                        ...
                        <Text
                          ...
                          Here's aslo where you can input your preferences
                          because you may have experience in one industry but
                          might just want to try something new.
                        </Text>
                      </View>
                    </View>
                  </ScrollView>
            ...
            <View style={[style.cardView]}>
              <View
                ...
                <Text
                  ...
                  Awesome! Your preferences has been added.
                </Text>
              </View>
              <TouchableOpacity
                style={{
