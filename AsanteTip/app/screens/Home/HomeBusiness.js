      ...
      <LinearGradient
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.innerCardView}>
                  ...
                  <View
                    ...
                    <Pressable
                      ...
                      <Text style={styles.tipBoxTxt}>Add Employee</Text>
                    </Pressable>

                    <Pressable
                      onPress={() => Navigation.navigate('BusinessStatement')}
                      style={styles.btnView}>
                      <NeomorphFlex
                        // inner // <- enable inner shadow
                        useArt // <- set this prop to use non-native shadow on ios
                      ...
                      <Text style={styles.tipBoxTxt}>Business Statement</Text>
                    </Pressable>
                    ...
                    <Pressable
                      ...
                      <Text style={styles.tipBoxTxt}>Receive Tip</Text>
                    </Pressable>
                  </View>
          ...
          <View style={styles.bottomView}>
            <Pressable
              onPress={() =>
                Navigation.navigate('ScanQRStack', {name: HomeBusiness})
              }
