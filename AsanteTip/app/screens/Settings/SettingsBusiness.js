          ...
          <View style={styles.topView}>
            ...
            <Pressable
              ...
              <NeomorphFlex
                ...
                <View style={styles.neomorphTxtView}>
                  <View style={styles.txtView}>
                    <Text style={styles.topTxt}>Add Employee</Text>
                    <Text style={styles.bottomTxt}>
                      Edit Employee details, remove employee, share employee QR
                      code
                    </Text>
                  </View>
            ...
            <Pressable
              ...
              <NeomorphFlex
                ...
                <View style={styles.neomorphTxtView}>
                  <View style={styles.txtView}>
                    <Text style={styles.topTxt}>Business Profile</Text>
                    <Text style={styles.bottomTxt}>
                      Business Information, QR Code, ID
                    </Text>
                  </View>
