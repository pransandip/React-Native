    ...
    <KeyboardAwareScrollView
      ...
      <LinearGradient
        ...
        <View style={styles.topView}>
          ...
          <Text style={styles.businessTxt}>Sign Up</Text>
          ...
          <NeomorphFlex
            ...
            <TextInput
              ...
              // maxLength={10}
              value={emailMobile}
              // onChangeText={val => setEmailMobile(val)}
              // onChangeText={val => setEmailMobile(val)}
          ...
          <Pressable
            ...
            <NeomorphFlex
              ...
              <LinearGradient
                ...
                style={styles.btnGradient}>
                <Text style={[styles.loginTxt, {fontSize: moderateScale(15)}]}>
                  Sign up as Business A/c
                </Text>
              </LinearGradient>
            </NeomorphFlex>
          </Pressable>
        ...
        <View style={styles.checkboxView}>
          <CheckBox onChangeVal={val => setSigninCheck(val)} />
          <Text style={styles.tcTxt}>Terms and conditions</Text>
        </View>
        {/* </ScrollView> */}
      </LinearGradient>
