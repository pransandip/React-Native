...
import HomeBusiness from '../../screens/Home/HomeBusiness';
import SettingsBusiness from '../../screens/Settings/SettingsBusiness';
import ScanQR from '../../screens/scanQR/ScanQR';
import Wallet from '../../screens/Wallet/Wallet';

const Tab = createBottomTabNavigator();

const BottomTabsBusiness = () => {
  return (
    <Tab.Navigator
      tabBarOptions={{
        showLabel: false,
...
export default BottomTabsBusiness;
